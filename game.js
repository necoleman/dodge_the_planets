...
export class Game {
    ...
    constructor(mouseControl, maxX, maxY, numPlanets){
        ...
        this.model = new NeuralNet(4*(this.spaceObjectList.length + 1) + 2, 2, "LOGISTIC");
    ...
    _generatePlanet(spaceObjectList, maxX, maxY){
        ...
        // this makes mass totally random var newMass = Math.random()*(maxMass - minMass) + minMass;
    ...
    predictMove(){
        ...
        for(var j=0; j<possibleMoves.length; j++){
            ...
            valueFunc.push(this.model.predict(gameState.concat([angle, accel])[0]))
        }
        ...
        return {"angle": finalAngle, "rocket": rocket}
    }
